    ...
    <div id="privacy" className="bg-neutral-950 text-white font-sans p-8 md:px-16 lg:px-24 min-h-screen">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-8 leading-relaxed">
          Welcome to Red Stream. This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from <a href="https://www.red-stream.store" className="text-red-500 hover:underline">https://www.red-stream.store</a> (the "Site").
        </p>

        <h3 className="text-xl font-semibold mb-4 text-gray-200">1. Information We Collect</h3>
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-200">2. How Do We Use Your Personal Information?</h3>
        ...
        <p className="mb-4 leading-relaxed text-gray-300">Additionally, we use this information to:</p>
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-200">3. Sharing Your Personal Information</h3>
        <p className="mb-8 leading-relaxed text-gray-300">
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-200">4. Data Security</h3>
        <p className="mb-8 leading-relaxed text-gray-300">
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-200">5. Use of Cookies</h3>
        <p className="mb-8 leading-relaxed text-gray-300">
        ...
        <h3 className="text-xl font-semibold mb-4 text-gray-200">6. Consent</h3>
        <p className="mb-8 leading-relaxed text-gray-300">
          By using our site, you consent to our online privacy policy.
        </p>

        <h3 className="text-xl font-semibold mb-4 text-gray-200">7. Contact Us</h3>
        <p className="mb-8 leading-relaxed text-gray-300">
